...
class MyArm:
    ...
    def yellow_one(self, mc) :
        ...
        time.sleep(2)
        mc.send_angles([0, 24.87, -73.91, -27.5, 90.43, -1], 40)
        time.sleep(2)
        mc.set_gripper_value(40, 40)
        time.sleep(2)
    ...
    def yellow_two(self, mc) :
        mc.send_angles([8.61, 21.88, -52.73, -43.25, 85.34, 1.14], 60)
        time.sleep(2)
        mc.set_gripper_value(40, 40)
        time.sleep(2)
    ...
    def orange_two(self, mc) :
        mc.send_angles([0.96, -11, -27, -34, 90, 2.1], 40)
        time.sleep(2)
        mc.set_gripper_value(60, 40)
        time.sleep(2)
        mc.send_angles([6.76, -6.15, -35.06, -19.42, 85.86, 10.19], 40)
    ...
    def red_two(self, mc) :
        mc.send_angles([1.4, -37.89, 12, -39, 90.08, -0.08], 40)
        time.sleep(2)
        mc.set_gripper_value(60, 40)
        time.sleep(2)
        mc.send_angles([1.58, -35.85, -7.73, 6.5, 91.05, -4.04], 40)
